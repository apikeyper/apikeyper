...
const mockUser = {
  ...
  profilePictureUrl:
    "https://lh3.googleusercontent.com/a/ACg8ocJeui0JxrWCISlo4nWnCmANIhvlOzFgq-dQcRGe03W8TK7ZxN5MeQ=s317-c-no",
};
  ...
  return (
    <div className="flex items-center justify-between gap-2 rounded-[8px] p-1 text-black/50 dark:text-white">
      ...
      <div className="grow">
        ...
        <p className="text-[12px] text-neutral-500">{mockUser?.email}</p>
      </div>
    </div>
  );
}
