...
func (s *Server) RegisterRoutes() http.Handler {
	...
	r.Get("/rootKey/{root_key}", s.FetchRootKeyByIdHandler)
	...
	r.Get("/api/{api_id}/keys", Auth(s.Db, s.ListApiKeysForApiHandler))
	...
	r.Get("/apiKey/list", Auth(s.Db, s.ListApiKeysForApiHandler))
